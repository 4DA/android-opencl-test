...
//        TextView tv = (TextView) findViewById(R.id.sample_text);native
...
public class MainActivity extends Activity
{
    ...
    private void loadInputImage (String path)
    {
        ...
        if(Build.FINGERPRINT.contains("generic")) //emulator, we are very memory limited
        {
            Log.i("AndroidBasic", "Android emulator is detected, redusing resolution by 2x");
            displayWidth  /=2;
            displayHeight /=2;
        }
